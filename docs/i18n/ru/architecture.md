<!-- fennara-i18n: locale=ru source=docs/architecture.md sha256=8e2ee9acd604c495443d0f17d8274274cc488361e3fcec9e63cad2ea4c2b979d -->
<a id="architecture"></a>
# Архитектура
...
| --- | --- |
| Windows | Нативный дочерний или наложенный WebView2, присоединенный к окну редактора Godot. |
| macOS | Нативный WKWebView, присоединенный к окну редактора Godot. |
